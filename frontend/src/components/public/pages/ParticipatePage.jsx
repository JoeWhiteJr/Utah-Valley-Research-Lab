  ...
  return (
    <div className="min-h-screen pt-24 pb-20 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-pub-blue-100 text-pub-blue-700 rounded-full text-sm font-medium mb-4">
        ...
        {/* Loading */}
        {loading && (
          <div className="text-gray-500">Loading studies&hellip;</div>
        )}
        ...
        {!loading && !error && studies.length === 0 && (
          <div className="bg-white border border-gray-200 rounded-xl p-10 text-center">
            <MailQuestion className="w-12 h-12 text-gray-300 mx-auto mb-3" />
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 text-pub-blue-600 hover:text-pub-blue-700 font-medium"
            >
        ...
        {!loading && (
          <div className="mt-12 bg-white border border-gray-200 rounded-xl p-6">
            <h3 className="font-semibold text-gray-900 mb-3">A few things to know before you start</h3>
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li>
                &bull; Read our{' '}
                <Link to="/privacy" className="text-pub-blue-600 hover:underline">
                  privacy policy
                </Link>{' '}
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-shadow overflow-hidden">
      <div className="p-6 md:p-8">
        ...
        {study.blurb && (
          <p className="text-gray-600 mb-5 leading-relaxed">{study.blurb}</p>
        )}
