...
import { LayoutDashboard, User, FolderKanban, Settings, LogOut, Menu, X, MessageCircle, Shield, ExternalLink, Search, Sun, Moon, WifiOff, BookOpen, Code, FlaskConical } from 'lucide-react'
...
export default function Layout() {
  ...
  const navItems = [
    ...
    ...(user?.role === 'admin' ? [
      { to: '/dashboard/admin', icon: Shield, label: 'Admin', badge: adminBadge },
      { to: '/dashboard/admin/research-studies', icon: FlaskConical, label: 'Studies' },
    ] : []),
